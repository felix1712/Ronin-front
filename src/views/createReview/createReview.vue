...
<script>
  ...
  export default{
    ...
    methods: {
      ...
      changeReviewDue() {
        let getStartDate = new Date(this.dataReview.review_start_date);
        let dueValue = parseInt(this.review.deadline);
      ...
      addMember() {
        this.selectedMembers.forEach(function(value){
          ...
          var checkDataArr = this.dataReview.members.filter(function(item){
      ...
      checkboxMember(e){
        if(e.target.checked == true){
          this.addMember();
           ...
           this.removeMember(event.target.value);
        }
      },
